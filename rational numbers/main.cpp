...
define compare_r(x) bool operator x (const rational &r) \
        return ((this->numerator*r.denominator)x(r.numerator*this->denominator));
#define compare_r_i(x) bool operator x (const int &a) \
        return ((this->numerator*r.denominator)x(a*this->denominator));
#define compare_i_r(x) bool operator x (const int &a, rational &r) \
        return ((rational(i))x(r));
...
public:
    ...
    bool operator==(rational r) { // const? no we should simplify
            // a) *this-r==0
            // b) int d = gcd( numerator, denominator );
            //return this->numerator*d==r.numerator*d;
            return this->numerator==r.numerator&&this->denominator==r.denominator;
    }
    bool operator!=(rational r) { return !(*this==r); }
   ...
   // rational operator+(int n) { numerator+=n; return this; }
    ...
    rational operator*(int n) { rational r=*this; r.numerator*=n; this->simplify(); return r; }
    ...
    // macros to generate comparison methods
    compare_r(==)
    compare_r(!=)
    compare_r(<)
    compare_r(>)
